...
function renderNodes() {
    ...
    state.nodes.forEach(node => {
        ...
        el.innerHTML = `
            <div class="node-delete" onclick="event.stopPropagation(); removeNode(${node.id})"><i class="fas fa-times"></i></div>
...
function addEdge(sourceId, targetId) {
    ...
    if (state.edges.some(e => (e.sourceId === sourceId && e.targetId === targetId) || (e.sourceId === targetId && e.targetId === sourceId))) return;
